...
class TestBar(unittest.TestCase):
	...
	def test_yields_input_values(self):
	...
	def test_tracks_task_and_completes(self):
	...
	def test_total_defaults_to_length(self):
	...
	def test_transient_removal(self, name, transient, break_early, expected_remaining):
