...
class TestNewDict(unittest.TestCase):
	...
	# =========================================================================
	def test_01_print_no_recursion(self):
	...
	#    dict() + reversed().
	# =========================================================================
	def test_02_dict_ops_all_convert_modes(self):
	...
	# =========================================================================
	def test_05_convert_flag_stored_as_passed(self):
	...
	# =========================================================================
	def test_06_lazy_convert_one_level(self):
		d = Dict({'a': {'b': {'c': 1}}})
	...
	# =========================================================================
	def test_07_nested_plain_dict_is_newdict(self):
		class tmp(dict): ...
		a = Dict(tmp({'a': {'b': 1}}))
	...
	# =========================================================================
	def test_09_multiple_inheritance(self):
	...
	# =========================================================================
	def test_10_pickle_roundtrip(self):
		x = [
	...
	# =========================================================================
	def test_12_hasattr_missing(self):
		x = Dict({'a': 1, 'b': 2})
	...
	# =========================================================================
	def test_13_or_precedence(self):
		a = Dict(a=1)
		b = Dict(a=2)
		assert (a | b).a == 2
		assert (b | a).a == 1
	...
	# =========================================================================
	def test_14_empty_is_dict_and_mapping(self):
		x = Dict()
	...
	# =========================================================================
	def test_18_create_true_autovivify(self):
		d = Dict(_create=True)
		d.a.b.c = 1
		assert d.a.b.c == 1
		assert type(d.a) is Dict
	...
	# =========================================================================
	def test_19_create_custom_callable(self):
	...
	# =========================================================================
	def test_20_missing_without_create(self):
		d = Dict({'a': 1})
		try:
			_ = d['nonexistent']
	...
	# =========================================================================
	def test_21_in_no_side_effect(self):
		d = Dict(_create=True)
	...
	# =========================================================================
	def test_22_hasattr_getattr_suppress_create(self):
		d = Dict(_create=True)
	...
	# =========================================================================
	def test_24_copy_deepcopy(self):
	...
	# =========================================================================
	def test_25_update_converts(self):
	...
	# =========================================================================
	def test_26_convert_and_cache(self):
	...
	# =========================================================================
	def test_27_no_double_wrap(self):
	...
	# =========================================================================
	def test_28_get_no_autovivify(self):
		d = Dict(_create=True)
	...
	# =========================================================================
	def test_30_method_conversion_matrix(self):
	...
	def test_31_method_semantics(self):
	...
	# =========================================================================
	def test_32_flag_inherit_and_override(self):
	...
	# =========================================================================
	def test_35_pickle_preserves_subclass(self):
		d = Dict(_Special({'a': 1}))
	...
	# =========================================================================
	def test_36_pickle_preserves_commentedmap(self):
		from ruamel.yaml.comments import CommentedMap
		cm = CommentedMap({'a': 1, 'b': 2})
		cm.yaml_set_comment_before_after_key('a', before='hello')
		d = Dict(cm)
	...
	# =========================================================================
	def test_37_copy_preserves_commentedmap(self):
		from ruamel.yaml.comments import CommentedMap
		cm = CommentedMap({'a': 1, 'b': 2})
		cm.yaml_set_comment_before_after_key('a', before='hello')
		d = Dict(cm)
	...
	# =========================================================================
	def test_38_copy_independent_create(self):
		d = Dict(_create=True)
		c = d.copy()
	...
	# =========================================================================
	def test_39_copy_function(self):
	...
	# =========================================================================
	def test_40_copy_false_unsupported_source(self):
	...
	# =========================================================================
	def _test_41_self_referential(self):
	...
	# =========================================================================
	def test_42_okay_private_keys_autovivify(self):
		class WithOkay(Dict):
	...
	# =========================================================================
	def test_43_nested_mapping_identity_stable(self):
	...
	# =========================================================================
	def test_44_settings_object(self):
		conv = lambda m: Dict(m)
		cr = lambda k: f'v-{k}'
	...
	# =========================================================================
	def test_45_or_consistency(self):
