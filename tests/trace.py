...
from epicstuff import NewDict as Dict, rich_trace, rich_try, update_trace
from epicstuff import trace as _trace
...
class TestTrace(unittest.TestCase):
	def test_rich_try_shows_local_not_truncated(self):
	...
	def test_rich_try_shows_local_truncated(self):
	...
	def test_update_trace_truncation_in_flight(self):
	...
	def test_rich_trace_no_raise_is_silent(self):
	...
	def test_rich_try_async_return_and_hidden_locals(self):
	...
	def test_rich_try_context_manager_suppresses(self):
	...
	def test_raise_modes(self, name, raise_mode, should_reraise, expected_return):
